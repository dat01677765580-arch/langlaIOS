...
//        this.a(this.a.cx + this.a.width / 2 - 50, this.h - 25 + 100, Caption.P, this, 1001, 13); // code cu
        this.btnMain = this.a(this.a.cx + this.a.width / 2 - 50, this.h - 25 + 100, Caption.P, this, 1001, 13); // code moi
...
// a(new LangLa_cd1(this,null));
    ...
    public void a(Graphics var1) {
        ...
        super.a(var1);
        mImage image = AutoPro.getIconTool();
        var1.a(
                image,
                0,
                0,
                ...
                image.d,
                0,
                DataCenter.gI().widthScreen / 2,
                (DataCenter.gI().heightScreen / 2) - (30 / 2 * DataCenter.gI().zoomLevel),
                (int) (image.c / 6 * DataCenter.gI().zoomLevel),
                (int) (image.d / 6 * DataCenter.gI().zoomLevel),
                33
        );
        image = AutoPro.getIconTool2();
        var1.a(image, 0, 0, image.c, image.d, 0, DataCenter.gI().widthScreen / 2, this.k - 10 + mFont.a(mFont.e) / 2, (int) ((image.c / 3 * DataCenter.gI().zoomLevel)), (int) ((image.d / 3 * DataCenter.gI().zoomLevel)), 33);

        //getIconTool()
        // LangLa_fq.a(var1, 37, 0, this.a.cx + this.a.width / 2 - 2, this.h - 40, 33);
...
//            //     mFont.b(mFont.d, var1, "Bạn đang chọn Server Lậu", this.width / 2, this.h - 45, 2, -2560, -16742145);
//
//            if (DataCenter.gI().aP.array != null) {
//                mFont.b(mFont.d, var1, "[+] " + DataCenter.gI().aP.array.nameServers + " [+]", this.width / 2, this.h - 35, 2, -2560, -16742145);
//            }
//        }
        mFont.a(var1, "Làng Lá", 8 + AppListener.gI().o, 8, 0, -1);
...
//                return;
            ...
            case 1014:
                ...
                return;
            case 2002:
//                Gdx.net.openURI("https://thegioinhangia.com/"); // link đăng ký code cu
                setRegisterMode(!this.isRegisterMode); // code moi
                return;
            default:
        }
    }
...
//            }
    ...
    public Message l() {
        ...
        try {
            if (this.isRegisterMode) {
                var1 = Message.c((byte) -121);
                var1.writeUTF(this.a.f());
...
//    }
    ...
    private void setRegisterMode(boolean register) {
        ...
        if (register) {
            this.s.a = "Quay lại đăng nhập";
            this.btnMain.a = "Đăng ký";
            this.a.a("");
            this.b.a("");
        } else {
            this.s.a = Caption.ot;
            this.btnMain.a = Caption.P;
            this.a.a("");
            this.b.a("");
        }
    }
    ...
    private void registerAccount() {
        String user = this.a.f().trim();
        String pass = this.b.f().trim();

        if (user.length() < 6) {
            l("Tài khoản tối thiểu 6 ký tự");
            return;
        }

        if (user.length() > 15) {
            l("Tài khoản tối đa 15 ký tự");
            return;
        }

        if (pass.length() < 6) {
            l("Mật khẩu tối thiểu 6 ký tự");
            return;
        }

        if (pass.length() > 15) {
            l("Mật khẩu tối đa 15 ký tự");
            return;
        }
        this.t = false;
        g();
