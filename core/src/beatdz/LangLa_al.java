...
public class LangLa_al extends LangLa_kj {
    ...
    public void a() {
        ...
        for (int var2 = 0; var2 < Char.gI().arrItemBag.length; ++var2) {
            if (isLucDao) {
                if (Char.gI().arrItemBag[var2] != null && Char.gI().arrItemBag[var2].LD() && !Char.gI().arrItemBag[var2].WTD()) {
                    //check tb lục đạo
                    this.t[var1] = Char.gI().arrItemBag[var2];
                    ++var1;
                }
            } else if (isThienDao) {
                if (Char.gI().arrItemBag[var2] != null && Char.gI().arrItemBag[var2].TD() && !Char.gI().arrItemBag[var2].WVC()) {
                    //check tb thiên đạo
                    this.t[var1] = Char.gI().arrItemBag[var2];
                    ++var1;
                }
            } else if (isHienNhan) {
                if (Char.gI().arrItemBag[var2] != null && Char.gI().arrItemBag[var2].G() && !Char.gI().arrItemBag[var2].WLD()) {
                    //check tb hiền nhân
                    this.t[var1] = Char.gI().arrItemBag[var2];
                    ++var1;
                }
...
//            mFont.b(mFont.d, var1, Caption.kL + DataCenter.gI().ItemOptionTemplate[165].name, 14, this.a_() + 125, 0, -2560, -16777216);
                mFont.b(mFont.d, var1, Caption.kL, 14, this.a_() + 125, 0, -2560, -16777216);
            }
                ...
                case 0:
                    ...
                    try {
                        ...
                        if (var5.a[0] != null && var2 != 0) {
                            Message var6;
                            if (isLucDao) {// nếu là lục đạo gửi msg nâng thiên đạo
                                ...
                                var6.send();
                            } else if (isThienDao) {// nếu là th đạo gửi msg nâng vc
