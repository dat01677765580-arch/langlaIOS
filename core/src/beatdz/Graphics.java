...
public class Graphics {
    ...
    private static void a(BitmapFont var0, float var1, float var2) {
        // Null-safe scaling: fonts may not be initialized yet on the render thread.
        if (var0 == null) {
            createFont();
            return;
        }
