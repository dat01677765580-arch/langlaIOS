...
public class Utlis {
    public static String ipsv = "https://thegioinhangia.com/serverlist000.txt";
    ...
    public static FileHandle internal(String var0) {
        ...
        // Use forward slashes for internal paths so LibGDX can resolve assets on all platforms
