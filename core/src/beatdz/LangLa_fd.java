        ...
        switch (this.k()) {
            case 0:
                ...
                if (!var8.F && GameSrc.gI().aD != null && GameSrc.gI().aD.d) {
                    ...
                    if (var8.d == 0) {
                        var9 = var9 + " " + Utlis.numberFormat(DataCenter.gI().dataGiftQuaySo[var8.d][var8.c]) + Caption.cD + "" + Caption.cH + Utlis.numberFormat(DataCenter.gI().dataGiftQuaySo[4][var8.c]) + Caption.cE;
                    } else if (var8.d == 1) {
                        var9 = var9 + " " + Utlis.numberFormat(DataCenter.gI().dataGiftQuaySo[var8.d][var8.c]) + Caption.cF + "" + Caption.cH + Utlis.numberFormat(DataCenter.gI().dataGiftQuaySo[4][var8.c]) + Caption.cE;
                    } else if (var8.d == 2) {
                        var9 = var9 + " " + Utlis.numberFormat(DataCenter.gI().dataGiftQuaySo[var8.d][var8.c]) + Caption.cG + "" + Caption.cH + Utlis.numberFormat(DataCenter.gI().dataGiftQuaySo[4][var8.c]) + Caption.cE;
                    } else if (var8.d == 3) {
