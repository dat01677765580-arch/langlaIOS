...
public class LangLa_an extends LangLa_kj {
   ...
   public void b() { //sửa thêm option cho nâng cấp hiền nhân lục đạo
      super.b(); //vũ khí hiền nhân
      if (this.k() == 0) {
         if (!this.f) {
            if (this.a[0] == null) {
               this.a[1] = null;
               ...
               for(int var8 = 0; var8 < var2.length; ++var8) {
                  if (var2[var8].a[0] != 148) {
                     ...
                     var3.add(var2[var8]);
                     if (!var7) {
                        if (this.a[1].getItemTemplate().levelNeed / 10 == 2 && var2[var8].getItemOptionTemplate().type == 4) {
                           var3.add(new ItemOption("31,350,-1"));
                           var3.add(new ItemOption("41,120,-1"));
                           var3.add(new ItemOption("47,150,-1"));
                           var7 = true;
                        }
                        if (this.a[1].getItemTemplate().levelNeed / 10 == 3 && var2[var8].getItemOptionTemplate().type == 5) {
                           var3.add(new ItemOption("41,130,-1"));
                           var3.add(new ItemOption("47,150,-1"));
                           var7 = true;
                        }
