...
public class LangLa_ge extends LangLa_fn {
    ...
    public LangLa_ge(MainScreen var1, String[] var2) {
        ...
        this.e();
        DataCenter.gI();
        this.a[0] = new LangLa_ii((byte) 0, 103, this.a_() + 131, 92, 20, 92, 1);
        this.a[1] = new LangLa_ii((byte) 0, 103, this.a_() + 155, 92, 20, 92, 1);
        this.a[2] = new LangLa_ii((byte) 0, 199, this.a_() + 131, 92, 20, 92, 1);
        this.a[3] = new LangLa_ii((byte) 0, 199, this.a_() + 155, 92, 20, 92, 1);
        this.a(var5.b);
    ...
    private void e() {
        DataCenter.gI();
        this.j[0] = new LangLa_ij((byte) 1, 7, this.a_() + 3, 288, 128, 32, Utlis.c(this.t.length, 9), 9);
        this.j[1] = new LangLa_ij((byte) 0, 7, this.a_() + 147, 96, 32, 32, Utlis.c(Char.gI().arrItemExtend.length, 1), 1);
    }
