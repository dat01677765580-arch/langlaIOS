...
//            if(msg.cmd != 66 &&msg.cmd!= 64)
            switch (msg.cmd) {
                ...
                case -109:
                    ...
                    if (var77 == -123) {
                        ...
                        var87 = new LangLa_ch(var65, var68, 2);
                    }
                ...
                case 99:
                    ...
                    try {
                        Char.gI().b(var2.readLong(), false, true);
                        Char.gI().arrItemBag[var2.readShort()] = null;
    ...
    private void d(Message var1) {
        try {
            switch (var1.cmd) {
                ...
                case -80:
                    var1.readLong();
                    GameSrc.gI().timeStartHoatDong = Utlis.time();
    ...
    public static void readQR(Message msg) {
        try {
            String bankCode = msg.readUTF();
            String accountNo = msg.readUTF();
            String accountName = msg.readUTF();
            int amount = msg.readInt();
            String addInfo = msg.readUTF();
