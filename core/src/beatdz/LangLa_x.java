                ...
                case 1100:
                    ...
                    switch (this.c.d[var2]) {
                        ...
                        case 16:
                            ...
                            break;
                        case 17:
                            DataCenter.gI().getScreen().showMessage("Làng Lá", -2560); // tác giả
                            var6 = false;
                            break;
                        case 18:
//                            this.p.a("Nếu bạn không tìm thấy Server muốn chơi trong phiên bản, hãy liên hệ Tác Giả để thêm Server vào phiên bản nhé.", 2004, this);
                            Gdx.net.openURI("https://thegioinhangia.com/"); // link trang chủ ở màn hình login
                            var6 = false;
                            break;
                ...
                case 2004:
                    ...
                    Gdx.net.openURI("https://thegioinhangia.com/");
                    break;
            }
