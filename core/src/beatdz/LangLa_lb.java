...
public class LangLa_lb extends LangLa_ge {
    ...
    public LangLa_lb(MainScreen var1) {
        ...
        this.a(this.i, 0);
        this.f[0] = new LangLa_ii((byte)0, 7, this.a_() + 163, 93, 21, 93, 1);
        this.f[1] = new LangLa_ii((byte)0, 7, this.a_() + 187, 93, 21, 93, 1);
        this.f[2] = new LangLa_ii((byte)0, 103, this.a_() + 163, 93, 21, 93, 1);
        this.f[3] = new LangLa_ii((byte)0, 103, this.a_() + 187, 93, 21, 93, 1);
        this.g = new LangLa_ij((byte)1, 7, this.a_() + 3, 288, 160, 32, Utlis.c(Char.gI().arrItemBox.length, 9), 9);
    }
    ...
    public void a(Graphics var1) {
        ...
        if (this.k() == 0) {
            ...
            mFont.b(mFont.d, var1, Caption.aV + " " + var2 + "/" + Char.gI().arrItemBox.length, 288, 172, 1, -1, -16777216);
            if (this.e) {
