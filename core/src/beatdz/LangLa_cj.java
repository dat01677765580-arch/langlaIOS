        ...
        if (this.m && (this.width > 0 || this.cy > 0) || this.d) {
            ...
            switch (this.r) {
                case 3:
                    if (l == null) {
                        DataCenter.gI();
                        Pixmap var2;
                        (var2 = (l = mImage.a(140 * DataCenter.gI().zoomLevel, 45 * DataCenter.gI().zoomLevel)).b).setColor(new Color(0.0F, 0.0F, 0.0F, 0.0F));
                        var2.fill();
                        mImage var6 = LangLa_fq.a((int) 687);
                        Binary2.a(var2, var6.b, 105 * DataCenter.gI().zoomLevel, 0 * DataCenter.gI().zoomLevel, Blending.None);
                        var6 = LangLa_fq.a((int) 82);
                        Binary2.a(var2, var6.b, 105 * DataCenter.gI().zoomLevel, 25 * DataCenter.gI().zoomLevel, Blending.None);
                        var6 = LangLa_fq.a((int) 36);
                        Binary2.a(var2, var6.b, 80 * DataCenter.gI().zoomLevel, 0 * DataCenter.gI().zoomLevel, Blending.None);
                        var6 = LangLa_fq.a((int) 648);
                        Binary2.a(var2, var6.b, 80 * DataCenter.gI().zoomLevel, 25 * DataCenter.gI().zoomLevel, Blending.None);
                        var6 = LangLa_fq.a((int) 49);
                        Binary2.a(var2, var6.b, 55 * DataCenter.gI().zoomLevel, 0 * DataCenter.gI().zoomLevel, Blending.None);
                        var6 = LangLa_fq.a((int) 647);
                        Binary2.a(var2, var6.b, 55 * DataCenter.gI().zoomLevel, 25 * DataCenter.gI().zoomLevel, Blending.None);
                        if (!DataCenter.ar) {
                            var6 = LangLa_fq.a((int) 81);
                            Binary2.a(var2, var6.b, 30 * DataCenter.gI().zoomLevel, 0 * DataCenter.gI().zoomLevel, Blending.None);
                        }

                        if (Char.gI().rank >= 0) {
                            var6 = LangLa_fq.a((int) 660);
                            Binary2.a(var2, var6.b, 30 * DataCenter.gI().zoomLevel, 25 * DataCenter.gI().zoomLevel, Blending.None);
                        }
                        var6 = LangLa_fq.a((int) 1171);
                        Binary2.a(var2, var6.b, 5 * DataCenter.gI().zoomLevel, 25 * DataCenter.gI().zoomLevel, Blending.None);
            ...
            switch (this.r) {
                case 2:
                    ...
                    String var10003 = "Ping: " + ping + " ms";
                    var5 = var13 + 10;
                    mFont.a(var1, var10001, var11, var5, 1, -1);
                    mFont.a(var1, var10002, var11, var5 + 40, 1, -1);
                    //  mFont.a(var1, var10003, var11, var5 + 53, 1, 0xFFFFFF00);
                    ...
                    if (GameSrc.gI().E() && GameSrc.gI().timeHoatDong != 0) {
                        if (!GameSrc.gI().isHoatDongTime) {
                            ...
                            if (GameSrc.gI().getMapTemplate().type != 5 && GameSrc.gI().getMapTemplate().type != 6 && GameSrc.gI().getMapTemplate().type != 8 && GameSrc.gI().getMapTemplate().type != 10 && GameSrc.gI().getMapTemplate().type != 18) {
                                if (var15 > 0) {
...
//                  var10001 = Caption.fm + Utlis.j((int)((Utlis.time() - GameSrc.gI().timeStartHoatDong) / 1000L));
                            var10001 = Caption.fm + Utlis.j((int) ((GameSrc.gI().timeHoatDong + (Utlis.time() - GameSrc.gI().timeStartHoatDong)) / 1000L));
                            var5 += 10;
                            mFont.a(var1, var10001, var11, var5, 1, -1);
