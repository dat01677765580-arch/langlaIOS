...
public class Caption {
    ...
    public static String check(String var0) {
        if (var0 == null) return null;  // Handle null input

        if (Gdx.app.getType() == ApplicationType.iOS) {
            if (a == null || b == null || a.length != b.length) return var0;

            for (int var1 = 0; var1 < a.length; ++var1) {
                if (a[var1] != null && b[var1] != null && var0.contains(a[var1])) {
    ...
    public static void loadVN() {
        ...
        sD = new String[]{"Danh hiệu", "Vĩ thú","Pet"};
